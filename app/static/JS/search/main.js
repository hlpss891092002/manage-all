...
async function initialPage(){
  ...
  const result = await sentFetchWithoutBody("get",`/api/tableSearchItem/${itemName}`)
...
async function sent_input_search(body){
  let result = await sentFetchWithBody("post", body, `/api/search/${itemName}`)
  console.log(result)
};
